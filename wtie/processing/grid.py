...
class TimeDepthTable:
    ...
    def temporal_interpolation(self, dt: float, mode: str = "linear") -> "TimeDepthTable":
        ...
        interp = _interp1d(current_twt, current_tvd, kind=mode, bounds_error=False, fill_value="extrapolate")
    ...
    def depth_interpolation(self, dz: float, mode: str = "linear") -> "TimeDepthTable":
        ...
        interp = _interp1d(current_tvd, current_twt, kind=mode, bounds_error=False, fill_value="extrapolate")
