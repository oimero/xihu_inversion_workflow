...
DEFAULT_CURVE_STYLES = {
    "CAL": {"color": "brown", "range": (6, 16), "label": "CAL (in)"},
    "CALI": {"color": "brown", "range": (6, 16), "label": "CALI (in)"},
    ...
    "DT": {"color": "blue", "range": (40, 200), "label": "DT (us/ft)"},
    "AC": {"color": "blue", "range": (40, 200), "label": "AC (us/ft)"},
    "DEN": {"color": "red", "range": (1.95, 2.95), "label": "DEN (g/cm3)"},
    "RHOB": {"color": "red", "range": (1.95, 2.95), "label": "RHOB (g/cm3)"},
    "NPHI": {"color": "cyan", "range": (-0.15, 0.45), "label": "NPHI (v/v)"},
    ...
    "RT": {"color": "magenta", "range": (0.2, 2000), "label": "RT (ohm.mz)", "log": True},
